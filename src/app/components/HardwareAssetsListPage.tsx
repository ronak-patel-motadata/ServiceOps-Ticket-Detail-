...
const mockAssets: HardwareAsset[] = [
  { id: 'AST-001', name: 'MacBook Pro 16" — Design',                 flagged: true, assetType: 'Mac Laptop',      status: 'In Use',    hostName: 'DSGN-MAC-0041',  ipAddress: '10.20.18.41',  usedBy: { label: 'Aarav Sharma (aarav.sharma...)' },     managedByGroup: 'End User Computing', managedBy: { name: 'Rohan Mehta',    initials: 'RM', color: '#6366F1' }, serialNumber: 'C02FJ1ABMD6T' },
  { id: 'AST-002', name: 'Dell Latitude 7440 — Finance',            flagged: true, assetType: 'Windows Laptop',  status: 'In Use',    hostName: 'FIN-LT-0188',    ipAddress: '10.20.22.188', usedBy: { label: 'Priya Nair (priya.nair...)' },         managedByGroup: 'End User Computing', managedBy: { name: 'Tabrez Khan',    initials: 'TK', color: '#3D8BD0' }, serialNumber: '7HQ2X63' },
  ...
  { id: 'AST-005', name: 'Lenovo ThinkPad X1 Carbon — Engineering',  flagged: true, assetType: 'Windows Laptop',  status: 'In Use',    hostName: 'ENG-LT-0312',    ipAddress: '10.20.19.112', usedBy: { label: 'Karan Malhotra (karan.malho...)' },    managedByGroup: 'IT Operations',      managedBy: { name: 'Neha Raje',      initials: 'NR', color: '#EC4899' }, serialNumber: 'PF3X9K2' },
