...
export function AiSparkle({ size = 14, className }: { size?: number; className?: string }) {
  return (
    <svg width={(size * 48) / 40} height={(size * 48) / 40} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" className={className} style={{ flexShrink: 0 }}>
      <defs>
